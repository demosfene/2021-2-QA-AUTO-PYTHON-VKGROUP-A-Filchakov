...
class AudiencePageLocators(MainPageLocators):
    ...
    CREATE_NEW_SEGMENT_LOCATOR = (By.XPATH, '//button[contains(@class, "button button_submit")]')
    ITEM_SEGMENT_LOCATOR = (By.XPATH, '//div[contains(@class, "adding-segments-item adding-segments-item_active")]')
...
class CompanyPageLocators(MainPageLocators):
    ...
    TRAFFIC_BUTTON_LOCATOR = (By.XPATH, '//div[contains(@class, "column-list-item _traffic")]')
